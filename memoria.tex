...
\begin{document}
	...
	\label{chap:experimentos}
 	...
 	\begin{figure}[H]
 		...
 		\subfigure[Orden de conexión de los experimentos 1, 4]{\includegraphics[width=0.45\textwidth]{img/escenario1_2c_1}}
 		\hfill
 		\subfigure[Orden de conexión de los experimentos 2, 9]{\includegraphics[width=0.45\textwidth]{img/escenario1_2c_2}}
 		\hfill
 		\vspace{10pt} % Ajusta el espacio vertical entre las filas
 		\subfigure[Orden de conexión del experimento 3]{\includegraphics[width=0.45\textwidth]{img/escenario1_2c_3}}
 		\subfigure[Orden de conexión del experimento 5]{\includegraphics[width=0.45\textwidth]{img/escenario1_2c_4}}
 		\hfill
 		\vspace{10pt} % Ajusta el espacio vertical entre las filas
 		
 	
 		\subfigure[Orden de conexión del experimento 6]{\includegraphics[width=0.45\textwidth]{img/escenario1_2c_5}}
 		\hfill
 		\subfigure[Orden de conexión del experimento 7]{\includegraphics[width=0.45\textwidth]{img/escenario1_2c_6}}
 		
 		\vspace{10pt} % Ajusta el espacio vertical entre las filas
 		\subfigure[Orden de conexión del experimento 8]{\includegraphics[width=0.45\textwidth]{img/escenario1_2c_7}}
 		\hfill
 		\subfigure[Orden de conexión del experimento 10]{\includegraphics[width=0.45\textwidth]{img/escenario1_2c_8}}
